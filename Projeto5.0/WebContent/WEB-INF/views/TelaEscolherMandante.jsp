...
<html lang="pt-br">
 	<head>
  	...
  	<body>
		...
		<br>
			<div class="container">
				<form action="salvar_mandante" method="post">
				...
				<div class="row">
					<div id="menuTime" class="col-md-12">
						<hr>
						<p class="titulo-visualizar">Mandante - Rodada ${rodada }</p>
						<hr>
					</div>
				</div>
				<div class="row">
		        	<div class="col-md-6">
						<label for="mandanteVisitante"><b>Mandante/Visitante</b></label>
		        		<select class="form-control input-radius" name="mandanteVisitante" id="rodada">
		        			<c:if test="${partidasMandante < limite}">
		        			<option value="mandante">Mandante</option>
		        			</c:if>
		        			<c:if test="${partidasVisitante < limite}">
