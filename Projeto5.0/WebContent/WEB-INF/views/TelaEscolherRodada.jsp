...
<html lang="pt-br">
 	<head>
  	...
  	<body>
		...
		<br>
			<div class="container">
				<form action="salvar_partida" method="post">
				<input type="hidden" name="idCampeonato" value="${campeonato.id }">
				<input type="hidden" name="idTimeMandante" value="${timeMandante.id }">
				<input type="hidden" name="idTimeVisitante" value="${timeVisitante.id }">
				<div class="row">
					<div id="menuTime" class="col-md-12">
						<hr>
						<p class="titulo-visualizar">Escolher Rodada</p>
						<hr>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6">
						<label for="rodada"><b>Rodada:</b></label>
		        		<select class="form-control input-radius" name="rodada" id="rodada">
		        		<c:forEach var="rodada" items="${listaRodada}">
