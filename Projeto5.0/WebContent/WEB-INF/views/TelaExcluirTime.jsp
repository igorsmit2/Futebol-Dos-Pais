							...
							<div class="col-md-12">
								<nav id="menuVisualizar" style="width: 100%;"class="nav flex-column">
									...
									<a class="nav-link" href="ver_jogadores?id=${time.id}">Jogadores</a>
							  		<a class="nav-link" href="tela_alterar_time?id=${time.id}">Alterar Time</a>
									<div id="link-active"><a class="nav-link active-nav" href="tela_excluir_time?id=${time.id}">Excluir Time</a></div>
					...
					<div class="container-fluid">
						<div class="row">
							<div id="menuTime" class="col-md-12">
								<hr>
								<p class="titulo-visualizar">Excluir Time</p>
								<hr>
							</div>
						</div>
						<div class="row">
							...
							<div id="menuTime" class="col-md-4">
								<h4>Você tem certeza que deseja excluir este time?</h4>
								<br>
								<img src="${time.emblema}" style="height: 80px; width: 80px;"class="img-center img-responsive">
								<br>
								<br>
								<a href="visualizar_time?id=${time.id}" class="btn btn-outline-success btn-modal">Não</a>
								<a href="excluir_time?id=${time.id}" class="btn btn-danger btn-modal">Sim</a>
							</div>
						</div>
					</div>
				</div>
