 	...
 	<head>
  	...
  	<body>
		...
		<div id="titulo" class="container">
			<form action="buscar_times" method="post">
			<p class=" titulo">Times</p>
			<hr>
			<div class="container">
				...
				<div class="row">
					<div class="col-md-3">
					 ...
					 <div class="col-md-6">
						<div class="input-group mb-3">
  							<input type="text" class="form-control input-radius" name="chave" placeholder="Pesquisar Times (deixe vazio para trazer todos)" aria-describedby="button-addon2">
					...
					<div class="col-md-3 text-right">
						<a href="novo_time" class="btn btn-success btn-modal">Novo Time</a>
					</div>
				</div>
			</div>
			<hr>
					...
					<table id="tableFutebol" class="table">
  						...
  						<tbody>
    						...
    						<tr>
							    ...
							    <td>${time.nome}</td>
							    <td><a class="btn btn-success btn-sm btn-modal" href="visualizar_time?id=${time.id}">Visualizar</a></td>
    						</tr>
    						</c:forEach>
  						</tbody>
					</table>
