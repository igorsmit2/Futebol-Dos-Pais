			...
			<div class="row">
						...
						<div class="row">
							<div class="col-md-12">
								<nav id="menuVisualizar" style="width: 100%;"class="nav flex-column">
									...
									<div id="link-active"><a class="nav-link active-nav" href="ver_jogadores?id=${time.id}">Jogadores</a></div>
				...
				<div class="col-md-6">
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-md-12">
					<c:if test="${not empty listaJogadorTime}">
					<table id="tableFutebol" class="table">
  						...
  						<tbody>
  							<c:forEach var="jogador" items="${listaJogadorTime}">
    						<tr>
