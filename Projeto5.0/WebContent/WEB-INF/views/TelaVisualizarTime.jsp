						...
						<div class="row">
							<div class="col-md-12">
								<nav id="menuVisualizar" style="width: 100%;"class="nav flex-column">
									<div id="link-active"><a class="nav-link   active-nav" href="visualizar_time?id=${time.id}">Home</a></div>
				...
				<div id="menuTime" class="col-md-6">
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-md-2"></div>
							<div class="col-md-8">
								<figure class="foto-legenda text-center">
									<img src="${time.fotoEquipe}" />
								</figure>
							</div>
						</div>
						<div  class="row">
